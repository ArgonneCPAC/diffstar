...
# All simulations
from ..params_diffstarpopfits_mgash_ecrit_qt import (
    DiffstarPop_Params_Diffstarpopfits_mgash_ecrit_qt,
    DiffstarPop_UParams_Diffstarpopfits_mgash_ecrit_qt,
    sim_name_list,
)
...
def test_allsims():
    for sim_name in sim_name_list:
        _params = DiffstarPop_Params_Diffstarpopfits_mgash_ecrit_qt[sim_name]
        _uparams = DiffstarPop_UParams_Diffstarpopfits_mgash_ecrit_qt[sim_name]
