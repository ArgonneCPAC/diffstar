...
from ...defaults_mgash_ecrit import (
...
# All simulations
from ..params_diffstarfits_mgash_ecrit import (
    DiffstarPop_Params_Diffstarfits_mgash_ecrit,
    DiffstarPop_UParams_Diffstarfits_mgash_ecrit,
    sim_name_list,
)
...
def test_allsims():
    for sim_name in sim_name_list:
        _params = DiffstarPop_Params_Diffstarfits_mgash_ecrit[sim_name]
        _uparams = DiffstarPop_UParams_Diffstarfits_mgash_ecrit[sim_name]
